...
const OrdersPage = () => {
  ...
  const [searchQuery, setSearchQuery] = useState(''); // Fixed: Added setSearchQuery
  const [showCustomRange, setShowCustomRange] = useState(false);
  const [showExportDropdown, setShowExportDropdown] = useState(false);
  
  // --- STATE UPDATES ---
  // 1. Form state split into order-level and item-level
  ...
  // 2. Main orders state is now stateful (useState) and has nested items
  const [orders, setOrders] = useState([
    { 
      id: 1, date: '2024-01-15', distributor: 'MedSupply Co.', phone: '+91 98765 43210', 
      items: [{ itemName: 'Paracetamol 500mg', quantity: 100, advance: '₹2,500' }] 
    },
    { 
      id: 2, date: '2024-01-14', distributor: 'PharmaCorp Ltd.', phone: '+91 87654 32109', 
      items: [{ itemName: 'Amoxicillin 250mg', quantity: 50, advance: '₹1,200' }] 
    },
    { 
      id: 3, date: '2024-01-13', distributor: 'DiabetesCare Inc.', phone: '+91 76543 21098', 
      items: [{ itemName: 'Insulin Glargine', quantity: 20, advance: '₹8,000' }] 
    },
    { 
      id: 4, date: '2024-01-12', distributor: 'HealthPlus Dist.', phone: '+91 65432 10987', 
      items: [
  ...
  // --- 4. NEW HANDLERS for dynamic items ---
  ...
  const handleAddOrder = () => {
    ...
    setOrders([newOrder, ...orders]); // Add to state
    alert('Order added successfully!'); // Give user feedback
